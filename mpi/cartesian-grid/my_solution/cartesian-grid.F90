program cartesian_grid
  ...
  ! Neighbours in anti-clockwise: left, down, right, up
  call mpi_cart_shift(comm2d, 0, 1, neighbors(4), neighbors(2), rc)
  call mpi_cart_shift(comm2d, 1, 1, neighbors(1), neighbors(3), rc)
