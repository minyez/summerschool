...
void h5_writer(int my_id, int *localvector, int localsize)
{
    ...
    /* Create the dataset */
    dims = DATASIZE; // global dimension, as we use collective
    filespace = H5Screate_simple(1, &dims, NULL);
    dset_id = H5Dcreate(file_id, "data", H5T_NATIVE_INT, filespace, H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT); // same in serial/parallel
